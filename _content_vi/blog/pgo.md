...
Đầu năm 2023, Go 1.20 [đã phát hành bản xem trước của tối ưu hóa dựa trên hồ sơ thực thi (PGO)](/blog/pgo-preview) để người dùng thử nghiệm.
...
Trước khi đến đó, "tối ưu hóa dựa trên hồ sơ thực thi" chính xác là gì?
...
[Hướng dẫn GC Go](/doc/gc-guide#Identifying_costs) cho chúng ta biết rằng `runtime.gcBgMarkWorker` là một phần của bộ gom rác, vì vậy tiết kiệm từ `runtime.scanobject` phải là tiết kiệm GC.
