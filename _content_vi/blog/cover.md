...
Có một số đặc tính của Go khiến nó phù hợp với hệ thống công cụ.
...
Chương trình cung cấp test coverage trong Go 1.2 là công cụ mới nhất tận dụng sự hỗ trợ về hệ thống công cụ trong hệ sinh thái Go.
