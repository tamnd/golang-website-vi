...
value('tableOfContents', [{
    'id': 'mechanics',
    'title': 'Sử dụng tour',
    'description': '<p>Chào mừng đến với hành trình khám phá <a href="https://go.dev">ngôn ngữ lập trình Go</a>. Tour bao gồm những tính năng quan trọng nhất của ngôn ngữ, chủ yếu là:</p>',
    'lessons': ['welcome']
}, {
    'id': 'basics',
    'title': 'Cơ bản',
    'description': '<p>Điểm khởi đầu, tìm hiểu tất cả những kiến thức cơ bản của ngôn ngữ.</p><p>Khai báo biến, gọi hàm, và tất cả những gì bạn cần biết trước khi chuyển sang các bài học tiếp theo.</p>',
    'lessons': ['basics', 'flowcontrol', 'moretypes']
}, {
    'id': 'methods',
    'title': 'Phương thức và interface',
    'description': '<p>Tìm hiểu cách định nghĩa phương thức trên các kiểu dữ liệu, cách khai báo interface, và cách kết hợp tất cả lại với nhau.</p>',
    'lessons': ['methods']
}, {
    'id': 'generics',
    'title': 'Generics',
    'description': '<p>Tìm hiểu cách sử dụng tham số kiểu trong hàm và struct của Go.</p>',
    'lessons': ['generics']
}, {
    'id': 'concurrency',
    'title': 'Concurrency',
    'description': '<p>Go cung cấp các tính năng concurrency như một phần cốt lõi của ngôn ngữ.</p><p>Module này giới thiệu về goroutine và channel, cùng cách chúng được sử dụng để triển khai các mẫu concurrency khác nhau.</p>',
    'lessons': ['concurrency']
}]).
...
value('translation', {
    'off': 'tắt',
    'on': 'bật',
    'syntax': 'Tô sáng cú pháp',
    'lineno': 'Số dòng',
    'reset': 'Đặt lại slide',
    'format': 'Định dạng mã nguồn',
    'kill': 'Dừng chương trình',
    'run': 'Chạy',
    'compile': 'Biên dịch và chạy',
    'more': 'Tùy chọn',
    'toc': 'Mục lục',
    'prev': 'Trước',
    'next': 'Tiếp',
    'waiting': 'Đang chờ máy chủ...',
    'errcomm': 'Lỗi kết nối đến máy chủ.',
    'submit-feedback': 'Gửi phản hồi về trang này',
    ...
    'github-repo': 'github.com/tamnd/golang-website-vi',
    'issue-title': 'tour: [MO TA NGAN GON VAN DE]',
    'issue-message': 'Thay doi tieu de phia tren de mo ta van de cua ban va them phan hoi tai day, bao gom ca ma nguon neu can',
    'context': 'Ngu canh',
}).
